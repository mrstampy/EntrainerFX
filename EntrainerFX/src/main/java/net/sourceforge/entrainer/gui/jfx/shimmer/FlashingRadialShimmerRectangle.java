 ...
 * @author burton
 */
public class FlashingRadialShimmerRectangle extends AbstractFlashingShimmer<RadialGradient> {
	...
	/**
	 * Instantiates a new flashing radial shimmer rectangle.
	 */
	public FlashingRadialShimmerRectangle() {
		super();
		setId(CSS_ID);
	}
	...
	public String toString() {
		return "Flashing Radial Gradient";
	}

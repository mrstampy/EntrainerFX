...
/**
 * This class adds a custom interval to the {@link IntervalMenu} which instantiated it.
 * @author burton
 *
 */
public class CustomInterval extends JDialog {
	...
	class CustomIntegerTextField extends IntegerTextField {
		...
		/* (non-Javadoc)
		 * @see net.sourceforge.entrainer.widgets.IntegerTextField#isValidCharacter(char, int)
		 */
		@Override

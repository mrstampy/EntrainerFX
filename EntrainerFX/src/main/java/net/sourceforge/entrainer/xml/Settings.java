...
public class Settings {
  ...
  public void initState() {
    ...
    ReceiverChangeEvent e = new ReceiverChangeEvent(this,
        new Color(getBackgroundRed(), getBackgroundGreen(), getBackgroundBlue()),
        MediatorConstants.NO_BACKGROUND_COLOUR);

...
public class UnitSleeper {
  ...
  private EntrainerProgramUnit getUnitDifference(EntrainerProgramUnit last, EntrainerProgramUnit current) {
    ...
    unit.setEntrainmentFrequency(
        new EntrainerProgramUnitAttribute(last.getEndEntrainmentFrequency(), current.getStartEntrainmentFrequency()));
    unit.setFrequency(new EntrainerProgramUnitAttribute(last.getEndFrequency(), current.getStartFrequency()));
    unit.setPinkEntrainerMultiple(
        new EntrainerProgramUnitAttribute(last.getEndPinkEntrainerMultiple(), current.getStartPinkEntrainerMultiple()));

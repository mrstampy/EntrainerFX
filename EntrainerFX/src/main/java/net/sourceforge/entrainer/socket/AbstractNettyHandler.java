...
public abstract class AbstractNettyHandler<I extends Object> extends SimpleChannelInboundHandler<I> {
  ...
  private String getJson(EntrainerStateMessage message)
  ...
  private void fireReceiverChangeEvent(FlashColour c, MediatorConstants parm) {
    if (c == null) return;
    sender.fireReceiverChangeEvent(
        new ReceiverChangeEvent(this, new Color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha()), parm));
  }

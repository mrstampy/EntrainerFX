...
public class TimelineChain {
  ...
  public void pause() {
    synchronized (getMainObject()) {
      if (getCurrentPlaying() != null && (getCurrentPlaying().getState().equals(TimelineState.PLAYING_FORWARD)
          || getCurrentPlaying().getState().equals(TimelineState.PLAYING_REVERSE))) {
